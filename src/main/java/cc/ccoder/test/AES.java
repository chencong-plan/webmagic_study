...
/**
 * @author : ChenCong
 * @date : Created in 16:06 2018/1/2
 */
...
import cc.ccoder.util.HttpRequest;
...
public class AES {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("params=" + URLEncoder.encode(AES.get_params(first_param), "UTF-8"));
        System.out.println( "encSecKey=" + AES.get_encSecKey());

//        String params = URLEncoder.encode(AES.get_params(first_param), "UTF-8");
//        String encSeckey = AES.get_encSecKey();
//        String result = HttpRequest.sendPost("http://music.163.com/weapi/v1/resource/comments/R_SO_4_421423806", "params="+params+"&encSecKey="+encSeckey);
    }
}